...
public class Gantinama extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitude=(EditText)findViewById(R.id.latitudebox);
        longitude=(EditText)findViewById(R.id.longitudebox);
    }
